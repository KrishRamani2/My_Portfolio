...
const projects =[
  {
    ...
    description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique necessitatibus enim aliquid eius dicta tempore sed amet!",
    stack:[{name:"Html 5"},{name:"Css 3"},{name:"JavaScript"}],
    image:"/assets/resume/Image1.jpeg",
    live:"/",
    github:"/",
    },
  {
    ...
    description:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique necessitatibus enim aliquid eius dicta tempore sed amet!",
    stack:[{name:"Html 5"},{name:"Css 3"},{name:"JavaScript"}],
    image:'/assets/resume/Image2.webp',
    live:"/",
    github:"/",
  },
  {
        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
         <div className=" w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="flex flex-row gap-[25px]"><Link href={project.github}>
